...
class BrandSalesDetailReport(BaseCustomReport):
    report_name = "brand_sales_detail"
    ...
    def get_columns(self):
        ...
        {"fieldname": "brand", "label": "العلامة التجارية", "fieldtype": "Link", "options": "Brand", "width": 150},
        {"fieldname": "qty", "label": "الكمية", "fieldtype": "Float", "width": 100},
        {"fieldname": "rate", "label": "سعر البيع", "fieldtype": "Currency", "width": 120},
        {"fieldname": "amount", "label": "المبلغ", "fieldtype": "Currency", "width": 130},
    ...
    def get_data(self, filters):
        ...
        query = (
            ...
            "sii.item_code, sii.item_name, sii.brand, "
            "sii.qty, sii.rate, sii.amount, "
            "si.sales_person, si.cost_center "
    ...
    def get_summary(self, data, filters):
        ...
        return [
            {"label": "إجمالي المبيعات", "value": "%.2f" % total, "indicator": "Green"},
            {"label": "عدد المنتجات", "value": "%.0f" % total_qty, "indicator": "Blue"},
            {"label": "عدد الفواتير", "value": str(invoice_count), "indicator": "Orange"},
            {"label": "متوسط القطعة", "value": "%.2f" % avg, "indicator": "Purple"},
        ]
