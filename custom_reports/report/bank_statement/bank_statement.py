...
class BankStatementReport(BaseCustomReport):
    report_name = "bank_statement"
    ...
    def get_columns(self):
        ...
        {"fieldname": "debit", "label": "وارد", "fieldtype": "Currency", "width": 120},
        {"fieldname": "credit", "label": "صادر", "fieldtype": "Currency", "width": 120},
...
def execute(filters=None):
    return BankStatementReport().execute(filters)
