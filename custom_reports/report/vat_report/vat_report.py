...
class VatReportReport(BaseCustomReport):
    report_name = "vat_report"
    title = "VAT Report"
    icon = "percent"

    def get_columns(self):
        return [
            {"fieldname": "month", "label": "الشهر", "fieldtype": "Data", "width": 120},
            {"fieldname": "total_sales", "label": "إجمالي المبيعات", "fieldtype": "Currency", "width": 150},
            {"fieldname": "total_purchases", "label": "إجمالي المشتريات", "fieldtype": "Currency", "width": 150},
            {"fieldname": "output_vat", "label": "ضريبة المبيعات", "fieldtype": "Currency", "width": 150},
            {"fieldname": "input_vat", "label": "ضريبة المشتريات", "fieldtype": "Currency", "width": 150},
            {"fieldname": "net_vat", "label": "صافي الضريبة", "fieldtype": "Currency", "width": 150},
        ]
    ...
    def get_data(self, filters):
        ...
        sales_query = (
            ...
            "SUM(total_taxes_and_charges) as output_vat "
        ...
        purchase_query = (
            ...
            "SUM(total_taxes_and_charges) as input_vat "
        ...
        for month in all_months:
            ...
            result.append({
                "month": month,
                "total_sales": s.get("total_sales", 0) or 0,
                "total_purchases": p.get("total_purchases", 0) or 0,
                "output_vat": s.get("output_vat", 0) or 0,
                "input_vat": p.get("input_vat", 0) or 0,
                "net_vat": (s.get("output_vat", 0) or 0) - (p.get("input_vat", 0) or 0)
            })
        return result
    ...
    def get_summary(self, data, filters):
        ...
        return [
            ...
            {"label": "إجمالي المشتريات", "value": "%.2f" % total_purchases, "indicator": "Blue"},
            {"label": "صافي الضريبة", "value": "%.2f" % net_vat, "indicator": "Orange"},
        ]
